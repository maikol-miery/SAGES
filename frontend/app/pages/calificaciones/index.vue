...
const irACargaSeccion = () => {
  // router.push('/calificaciones/seccion')
  console.log('Navegando a Carga por Sección...')
}

const irACargaEstudiante = () => {
  console.log('Navegando a Carga por Estudiante...')
}

const irAResumenGlobal = () => {
  console.log('Navegando a Resumen Global...')
}
...
<template>
    <div class="w-full min-h-[calc(100vh-70px)] flex justify-center items-center flex-col">
      ...
      <div class="px-20 grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <UCard 
          @click="irACargaEstudiante"
          class="max-w-[420px] h-80 cursor-pointer transition-all duration-200 hover:-translate-y-1 hover:shadow-md group"
          :ui="{ 
            base: 'overflow-hidden border border-slate-200/80 rounded-2xl bg-white w-full',
            body: { padding: 'p-8 flex flex-col items-start' },
            ring: 'ring-0'
      ...
      <!-- CAMBIOS RECIENTES -->
        ...
        <div class="lg:col-span-2 bg-slate-100/60 border border-slate-200 rounded-2xl p-6 flex flex-col justify-between">
          <div>
