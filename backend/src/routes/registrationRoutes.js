...
const { registerStudent, saveBulkRegistrations, updateRegistration, getAllRegistrations, updateFullRegistration} = require("../controllers/registrationController");
...
router.patch("/:id", authenticateToken, updateFullRegistration );
